...
function checkValid2() {
    // Check rows for matches of three and four candies
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns - 3; c++) {
            let candy1 = board[r][c];
            let candy2 = board[r][c + 1];
            ...
            if ((candy1.src === candy2.src && candy2.src === candy3.src && candy3.src === candy4.src) ||
                ...
                (candy2.src === candy3.src && candy3.src === candy4.src && !candy2.src.includes("blank"))) {
                return true;
            }
        }
    }

    // Check columns for matches of three and four candies
    for (let c = 0; c < columns; c++) {
        for (let r = 0; r < rows - 3; r++) {
            let candy1 = board[r][c];
            let candy2 = board[r + 1][c];
